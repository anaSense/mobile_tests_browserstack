...
public class DeviceDriverProvider implements WebDriverProvider {

    static DeviceDriverConfig deviceConfig = ConfigFactory.create(DeviceDriverConfig.class, System.getProperties());
